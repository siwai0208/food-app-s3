...
<body>
   <div id="app">
        <div class="wrapper">
            <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color:rgba(34,34,34,0.95); z-index:999; width:100%; position:fixed; color:#fefefe;">
                <div class="container">
            ...
            <footer class="footer_design">
                ...
                @endguest
                    ...
                    Easy Food Delivery!!<br>
                    <p style="font-size:2.4em">Food Delivery APP</p><br>
                    </div>
                    <p style="font-size:1.2em;">@copyright @siwai0208</p>
            </footer>
        </div>
   </div>
</body>
